  ...
  <div class="aa2picture">
    ...
    <div class="button-setting-wrapper">
      ...
      <div class="setting-wrapper">
        <label>文字色：<input type="color" v-model="charColor" /></label><br />
        <label>背景色：<input type="color" v-model="bgColor" /></label>
        <label>背景透過：<input type="checkbox" v-model="isBgTransparent" /></label><br />
        <label>余白上下：<input type="number" v-model="marginH" /> px</label><br />
        <label>余白左右：<input type="number" v-model="marginW" /> px</label><br />
        <label>画像サイズ8倍（JPEG用）：<input type="checkbox" v-model="isPic8x" /></label><br />
      </div>
    </div>
