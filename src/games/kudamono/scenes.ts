...
import {
  Player, Apple, Bomb, Particle, Tree,
  GameText, RectActor, FallingEntity
} from './actors'
import { WIDTH, HEIGHT, getGame } from './index'

export abstract class BaseScene extends Scene {
  addScore(_score: number) {}
  addParticle(_x: number, _y: number, _vx: number, _vy: number) {}
  showGameOver() {}
}
...
export class MainScene extends BaseScene {
  ...
  private entities: Map<number, FallingEntity> = new Map()
  ...
  addParticle(x: number, y: number, vx: number, vy: number) {
